...
public class StringTest {
	public static void main(String[] args) {
		...
		if(str1.equals(str2)) { // heap의 객체의 내용을 직접 비교
		...
		// 문자열 추출
		System.out.println("str 첫번째 문자: " + str.charAt(0));
		System.out.println("str 일곱번째 문자: " + str.charAt(6));
		
		// 문자열 자르기
		System.out.println("str 1~6까지 자르기: " +str.substring(0, 5));
		System.out.println("str 7부터 마지막까지 자르기: " +str.substring(6));
		
		// 문자열 인덱스
		System.out.println("str 앞에서부터 첫 문자 e 인덱스: " + str.indexOf("e"));
		System.out.println("str 뒤에서부터 첫 문자 e 인덱스: " + str.lastIndexOf("e"));
